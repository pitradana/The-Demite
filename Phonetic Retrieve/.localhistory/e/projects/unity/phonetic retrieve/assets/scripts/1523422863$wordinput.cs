...
public class WordInput : MonoBehaviour {
    ...
    string findPhonetic(string userInput) {
        ...
        while (reader.Read()) {
            ...
            totalSyllables = reader.GetString(7);
            ambiguityRate = reader.GetString(8);
            subKategori0 = reader.GetString(10);
            subKategori1 = reader.GetString(11);
            subKategori2 = reader.GetString(12);
        }
        reader.Close();
        reader = null;
        dbcmd.Dispose();
