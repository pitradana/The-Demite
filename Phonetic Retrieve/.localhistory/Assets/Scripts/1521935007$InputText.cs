...
public class InputText : MonoBehaviour {
    ...
    public string filename = "URI=file:"+Application.dataPath + "/words.db";
    ...
    string findPhonetic(string userInput) {
        ...
        string sqlquery = "Select phonetics from Noun where word =" + userInput;
        dbcmd.CommandText = sqlquery;
        IDataReader reader = dbcmd.ExecuteReader();
        while (reader.Read()) {
            phonetic = reader.GetString(0);
        }
